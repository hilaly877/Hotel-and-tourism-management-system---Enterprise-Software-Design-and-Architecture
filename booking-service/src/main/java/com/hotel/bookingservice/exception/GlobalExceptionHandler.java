...
public class GlobalExceptionHandler {
    ...
    // Handle calls to Guest/Room Service that return 404
    ...
    public ResponseEntity<Map<String, Object>> handleExternalServiceNotFound(HttpClientErrorException.NotFound ex) {
        ...
        error.put("message", "Guest or Room not found. Please check the guestId and roomId.");
    ...
    // Handle illegal arguments (e.g. check-in after check-out)
